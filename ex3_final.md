...
```
    ...
    ##            used  (Mb) gc trigger   (Mb) limit (Mb)  max used   (Mb)
    ## Ncells  5956730 318.2   16186265  864.5         NA  16186265  864.5
...
```
    ...
    ## + edges from 53a5084 (vertex names):
...
![](ex3_final_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
